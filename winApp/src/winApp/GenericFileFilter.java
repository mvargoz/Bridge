 ...
 * image files:
 *
 * JFileChooser chooser = new JFileChooser(); GenericFileFilter filter = new
 * GenericFileFilter( new String{"gif", "jpg"}, "JPEG & GIF Images")
...
public class GenericFileFilter extends FileFilter {
	...
	private Hashtable<String, GenericFileFilter> filters = null;
	...
	public GenericFileFilter() {
		this.filters = new Hashtable<String, GenericFileFilter>();
	}

	/**
	 * Creates a file filter that accepts files with the given extension.
	 * Example: new GenericFileFilter("jpg");
	 * 
	 * @see #addExtension
	 */
	 ...
	 * GenericFileFilter("jpg", "JPEG Image Images");
	 * 
	 ...
	 * GenericFileFilter(String {"gif", "jpg"});
	 * 
	 ...
	 * Example: new GenericFileFilter(String {"gif", "jpg"}, "Gif and JPG
	 * Images");
	 * 
	...
	public void addExtension(String extension) {
		if (filters == null) {
			filters = new Hashtable<String, GenericFileFilter>(5);
		}
