...
public class DonneBid {
	...
	public static int joueurToInt(String js) {
		if (js.equalsIgnoreCase("N"))
			return 0;
		else if (js.equalsIgnoreCase("E"))
			return 1;
		else if (js.equalsIgnoreCase("S"))
			return 2;
		else if (js.equalsIgnoreCase("O") || js.equalsIgnoreCase("W"))
			return 3;
		return -1;
	}

	public static char joueurToChar(int j) {
		if (j >= 0 && j < 4) {
			String s = "NESO";
			return s.charAt(j);
		}
	...
	public void putEnchere(String e) {
		Encheres[nbEnch++] = e;
	}
	...
	// retourne le n° du joueur jouant le contrat
